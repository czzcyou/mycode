...
- (void)configureSubviews {
    ...
    self.likeCountLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 16, self.frame.size.width / 3, 16)];
    ...
    self.honorCountLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.likeCountLabel.frame.origin.x-self.honorCountLabel.frame.size.width, 16, 320 / 3, 16)];
    ...
    UILabel *honorTipLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.likeCountLabel.frame.origin.x-self.honorCountLabel.frame.size.width, self.honorCountLabel.frame.size.height + 10, 320 / 3, 15)];
    ...
    self.reputationCountLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.honorCountLabel.frame.origin.x-self.reputationCountLabel.frame.size.width, 16, 320 / 3, 16)];
    ...
    UILabel *reputationTipLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.honorCountLabel.frame.origin.x-self.reputationCountLabel.frame.size.width, self.reputationCountLabel.frame.size.height + 10, 320 / 3, 15)];
